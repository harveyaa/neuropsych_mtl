#!/bin/bash
#SBATCH --job-name=cnn_conn_intra
...
#SBATCH --array=9-10
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/conn_cnn_intra_%a.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_paper/neg_transfer/cnn/single/'
