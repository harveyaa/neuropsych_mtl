#!/bin/bash
#SBATCH --job-name=concat_single_bal
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/concat_bal_test/'
...
echo 'Concat bal test - Single task MLP on '$task
...
do
    ...
    python $hps_balanced --tasks $task --type 'concat' --num_epochs 100 --batch_size 8 --encoder 5 --head 5 --data_format 0 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --fold $fold
done