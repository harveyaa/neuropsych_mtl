#!/bin/bash
#SBATCH --job-name=single_CNN_rand
...
#SBATCH --array=0-8
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/cnn_%a.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/single_CNN_rand/'
...
do
    ...
    python $hps_balanced --tasks $task --num_epochs 100 --batch_size 8 --encoder 0 --head 0 --data_format 1 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --fold $fold --rand_test
done