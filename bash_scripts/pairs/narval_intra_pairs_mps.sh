...
#SBATCH --array=1-55
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/pair_sm_%a.out

# NEGATIVE TRANSFER STUDY - Shared Middle PAIRWISE - paper version (intra-site CV)
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_paper/pairs/mps/'
