#!/bin/bash
#SBATCH --job-name=pairs_cnn_intra
...
# NEGATIVE TRANSFER STUDY - CNN PAIRWISE - paper version (intra-site CV)
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_paper/neg_transfer/cnn/'
