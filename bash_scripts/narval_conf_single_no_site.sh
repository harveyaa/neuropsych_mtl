#!/bin/bash
#SBATCH --job-name=conf_single_no_site
...
#SBATCH --array=0-8
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/single_conf_%a.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/conf_no_site/'
...
echo 'Conf no site - Single task MLP on '$task
...
do
    ...
    python $hps_balanced --tasks $task --type 'conf_no_site' --num_epochs 100 --batch_size 8 --encoder 6 --head 6 --data_format 0 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --fold $fold --rand_test
done