...
#SBATCH --array=0-59
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/sex_ukbb_mmoe_%a.out

# UKBB LEARNING CURVE STUDY - MTL SEX - MMOE
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_paper/sex/ukbb/mmoe/'
...
echo 'UKBB sites mtl MMOE on conn predicting SEX'
...
python $hps_conf --tasks $tasks --type 'conn' --n_subsamp $k --conf 'SEX' --num_epochs 100 --batch_size 8 --encoder 3 --head 3 --num_experts 6 --data_format 0 --fold $fold --log_dir $p_out --data_dir $data_dir