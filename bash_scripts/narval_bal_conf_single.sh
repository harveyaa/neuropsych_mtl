...
# EVALUTATE TEST SETS STUDY - SINGLE TASK CONDITIONS FROM CONFOUNDS
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results/confounds/'
