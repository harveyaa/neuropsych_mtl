#!/bin/bash
#SBATCH --job-name=conf_all_no_site
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/conf_no_site/all/'
...
echo 'Conf no site - All tasks MLP'
...
do
    ...
    python $hps_balanced --tasks $tasks --type 'conf_no_site' --num_epochs 100 --batch_size 8 --encoder 6 --head 6 --data_format 0 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --rand_test
done