...
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/age_all_no_ukbb.out

#['ds000030', 'Cardiff', 'UKBB', 'BC', 'UCLA', 'SFARI', 'ABIDE','Orban', 'ADHD200', 'ABIDE2']
tasks='ds000030 Cardiff BC UCLA SFARI ABIDE Orban ADHD200 ABIDE2'

# DATA PATH
data_dir='/home/harveyaa/projects/def-pbellec/harveyaa/data/'

# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/conf/age/all_no_ukbb/'
