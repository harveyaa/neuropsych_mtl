#!/bin/bash
#SBATCH --job-name=sex_all_no_ukbb
...
tasks='ds000030 Cardiff BC UCLA SFARI Orban ADHD200'

# DATA PATH
data_dir='/home/harveyaa/projects/def-pbellec/harveyaa/data/'

# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/conf/sex/all_no_ukbb/'
