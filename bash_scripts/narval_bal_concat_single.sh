#!/bin/bash
#SBATCH --job-name=single_concat_bal_test
...
# NEGATIVE TRANSFER STUDY - CONCAT BASELINE
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results/neg_transfer/concat/single/'
...
echo 'Single task MLP on concat w/ balanced test sets on '$task
