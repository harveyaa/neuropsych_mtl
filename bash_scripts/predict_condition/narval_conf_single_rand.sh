#!/bin/bash
#SBATCH --job-name=conf_single_rand
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results/condition/random/confounds/'
...
do
    ...
    python $hps_balanced --tasks $task --type 'conf' --num_epochs 100 --batch_size 8 --encoder 4 --head 4 --data_format 0 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --rand_test
done