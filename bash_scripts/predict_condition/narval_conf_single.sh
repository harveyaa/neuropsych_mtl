...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/results/conf/'
...
echo 'Conf - Single task MLP on '$task
...
do
    ...
    python $hps_balanced --tasks $task --type 'conf' --num_epochs 100 --batch_size 8 --encoder 4 --head 4 --data_format 0 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --fold $fold --rand_test
done