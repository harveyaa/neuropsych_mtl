...
# NEGATIVE TRANSFER STUDY - CNN PAIRWISE
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results/neg_transfer/cnn/'
