#!/bin/bash
#SBATCH --job-name=mmoe_10
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=annabelle.ahrv@gmail.com
#SBATCH --time=30:00:00
#SBATCH --mem=5G
#SBATCH --account=def-pbellec
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/mmoe_10.out

# CNVs & PSYCH STUDY - MTL CONDITIONS - MMOE w/ 10 EXPERTS
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_paper/mtl/mmoe_10/'
...
echo 'All tasks MMOE - 10 experts'
