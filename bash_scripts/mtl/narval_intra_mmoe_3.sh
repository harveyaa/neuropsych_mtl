...
do
    ...
    python $mmoe --tasks $tasks --type 'conn' --strategy 'balanced' --num_epochs 100 --batch_size 8 --num_experts 3 --encoder 3 --head 3 --data_format 0 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --fold $fold    
done