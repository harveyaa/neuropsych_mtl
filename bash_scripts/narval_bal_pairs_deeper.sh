#!/bin/bash
#SBATCH --job-name=pairs_conn_deeper
...
# NEGATIVE TRANSFER STUDY - MLPconn_deeper PAIRWISE
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results/neg_transfer/deeper/'
