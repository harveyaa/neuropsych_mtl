#!/bin/bash
#SBATCH --job-name=cnn_conn_bal_test
...
# NEGATIVE TRANSFER STUDY - CNN BASELINE
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results/neg_transfer/cnn/single/'
...
echo 'Single task CNN on conn w/ balanced test sets on '$task
