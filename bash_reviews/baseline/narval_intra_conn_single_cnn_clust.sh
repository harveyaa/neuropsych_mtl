#!/bin/bash
#SBATCH --job-name=cnn_clust_single
...
#SBATCH --array=0-2
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/cnn_clust_single_%a.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_reviews/baseline/cnn_clust/'
...
do
    ...
    python $hps_balanced --tasks $task --type 'conn' --strategy 'balanced' --num_epochs 100 --batch_size 8 --encoder 100 --head 0 --data_format 3 --log_dir $p_out --id_dir $id_dir --data_dir $data_dir --fold $fold
done