#!/bin/bash
#SBATCH --job-name=sex_all_shorter
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=annabelle.ahrv@gmail.com
#SBATCH --time=20:00:00
#SBATCH --mem=5G
#SBATCH --account=def-pbellec
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/sex_all_shorter.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_reviews/sex/model_vars/shorter/all/'
...
do
    ...
    python $hps_conf --tasks $tasks --type 'conn' --n_subsamp 50 --conf 'SEX' --num_epochs 100 --batch_size 8 --encoder 11 --head 11 --data_format 0 --fold $fold --log_dir $p_out --data_dir $data_dir
done