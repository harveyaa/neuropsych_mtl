#!/bin/bash
#SBATCH --job-name=single_age_thinner
...
#SBATCH --array=0-17
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/single_age_thinner_%a.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_reviews/age/model_vars/thinner/'
...
echo 'Single task MLPconn_thinner_reg on conn predicting AGE in '$task
...
do
    ...
    python $hps_conf --tasks $task --type 'conn' --n_subsamp 50 --conf 'AGE' --num_epochs 100 --batch_size 8 --encoder 10 --head 1010 --data_format 0 --fold $fold --log_dir $p_out --data_dir $data_dir
done
