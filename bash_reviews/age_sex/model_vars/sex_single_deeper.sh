#!/bin/bash
#SBATCH --job-name=single_sex_deeper
...
#SBATCH --array=0-13
#SBATCH -o /home/harveyaa/projects/def-pbellec/harveyaa/slurm_output/single_sex_deeper_%a.out
...
# OUT PATH
p_out_parent='/home/harveyaa/projects/def-pbellec/harveyaa/neuropsych_mtl/MTL/results_reviews/sex/model_vars/deeper/'
...
echo 'Single task MLPconn_deeper on conn predicting SEX in '$task
...
do
    ...
    python $hps_conf --tasks $task --type 'conn' --n_subsamp 50 --conf 'SEX' --num_epochs 100 --batch_size 8 --encoder 8 --head 8 --data_format 0 --fold $fold  --log_dir $p_out --data_dir $data_dir
done
